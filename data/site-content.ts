...
export const shortAbout = {
  ...
  highlights: [
    "6+ years across product, UX, and delivery in healthcare, wearables, and early-stage ventures",
    "Built product direction in regulated clinical environments and AI-enabled startup contexts",
    "Comfortable spanning discovery, prioritization, design partnership, stakeholder alignment, and implementation"
  ]
};
